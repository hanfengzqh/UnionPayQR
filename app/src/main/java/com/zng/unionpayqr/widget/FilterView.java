...
import com.zng.unionpayqr.pro.cashier_manage.adapter.FilterLeftAdapter;
import com.zng.unionpayqr.pro.cashier_manage.adapter.FilterOneAdapter;
import com.zng.unionpayqr.pro.cashier_manage.adapter.FilterRightAdapter;

/**
 * Created by sunfusheng on 16/4/20.
 */
@ContentView(R.layout.view_filter_layout)
public class FilterView extends LinearLayout implements View.OnClickListener {
	...
	private void show() {
		...
		llContentListView.getViewTreeObserver()
				.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
					...
					public void onGlobalLayout() {
						...
						ObjectAnimator.ofFloat(llContentListView, "translationY", -panelHeight, 0).setDuration(200)
								.start();
					}
				});
	}
