...
public class ModelUtil {
    ...
    public static List<FilterEntity> getFilterData() {
        List<FilterEntity> list = new ArrayList<>();
        list.add(new FilterEntity(UnionPayQRConstant.QRALL, "1"));
        list.add(new FilterEntity(UnionPayQRConstant.QRSCAN, "2"));
        list.add(new FilterEntity(UnionPayQRConstant.QRCODE, "3"));
        return list;
    }
